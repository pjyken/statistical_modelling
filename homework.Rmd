...
afit = glm(min.temp ~ longitude + latitude, family = gaussian, data = dft)
ifit = glm(min.temp ~ longitude + latitude + longitude:latitude, family = gaussian, data = dft)
...
http://homes.ori.org/~keiths/Files/Methods/Multicollinearity.html
http://www.few.vu.nl/~wvanwie/Courses/HighdimensionalDataAnalysis/WNvanWieringen_HDDA_Lecture4_RidgeRegression_20152016.pdf
...
http://arxiv.org/pdf/1509.09169.pdf
